package com.example.KCApp.config;
...
import com.example.KCApp.security.auth.RestAuthenticationEntryPoint;
import com.example.KCApp.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.authorizeRequests()
				.antMatchers("/pocetnaStranica.html", "/registracija.html", "/login.html", "/auth/**").permitAll()
				.antMatchers("/homepagepacijent.html").hasRole("PACIJENT")
